...
def gemiddelde_van_alle_studenten(studentencijfers):
    aantal_studenten = len(studentencijfers)
    gemiddelde_per_student = []
    for i in studentencijfers:
        gemiddelde_per_student.append(sum(i)/ len(i))
    gemiddelde = sum(gemiddelde_per_student) /aantal_studenten
