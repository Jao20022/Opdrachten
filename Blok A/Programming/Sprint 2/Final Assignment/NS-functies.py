...
def ritprijs(leeftijd, weekendrit, afstandKM):
    totaal = 0
    if weekendrit:
        totaal = standaardprijs(afstandKM) - standaardprijs(afstandKM) * 0.40
    else:
        if 12 > leeftijd or leeftijd >= 65:
            totaal = standaardprijs(afstandKM) - standaardprijs(afstandKM) * 0.30
        else:
            totaal = standaardprijs(afstandKM)
...
def development_code():
    ...
    print("development printout:", ritprijs(65, True, -51))
    print("development printout:", ritprijs(65, False, -51))
...
def test_ritprijs():
    ...
    testcases = [case(11, True, 50, 26.0), case(11, False, 50, 28.0), case(11, True, 51, 29.64),
                 ...
                 case(65, True, 51, 29.64), case(65, False, 51, 31.92), case(65, False, -51, 0.0),
                 case(65, True, -51, 0.0)]
