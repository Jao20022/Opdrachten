...
def analyzer(integerstring):
    ...
    tupl = (new, grootste, kleinste, aantal, som, gemiddelde)
    print(tupl)
    return tupl
    """
...
def development_code():
    ...
    print("Gesorteerde list van ints:", resultaat[0])
    print("Grootste getal:", resultaat[1], "en Kleinste getal:", resultaat[2])
    print("Aantal getallen:", resultaat[3], "en Som van de getallen:", resultaat[4])
    print("Gemiddelde:", resultaat[5])
